...
#
#         print("job_description_detailsis " + job_description_details)
...
#
#             print("response is " + open_ai_response)
#
...
#             #         job_description=request.POST.get("job_details", ""),
#             #     )
#             #
#             #     Proposal.objects.create(
#             #         user=request.user,
#             #         job_post=job_post,
#             #         final_text=open_ai_response,
#             #     )
#
